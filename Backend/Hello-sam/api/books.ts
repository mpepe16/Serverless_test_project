...
exports.handler = (event: { pathParameters: { id: any; }; httpMethod: any; body: string; }, context: any, callback: (arg0: null, arg1: { statusCode: number; headers: { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; } | { "Access-Control-Allow-Origin": string; }; body: string; }) => void) => {
	...
	switch (event.httpMethod) {
		...
		case "GET":
			...
			dynamodb.scan({ TableName: TABLE_NAME }, (err: any, data: { Items: any[]; }) => {
				if (err)
					callback(null, {
						statusCode: 400,
						headers: {
